...
var fetcher = function (_a) {
    ...
    return __awaiter(void 0, void 0, void 0, function () {
        var apiKey, domain, isDev, sortOption, constraints, baseUrl, encodedConstraints, uri, requestInit, result, response, _d, remaining, count, pages, index, cursor, res, _i, _e, element, error_1;
        return __generator(this, function (_f) {
            switch (_f.label) {
                case 0:
                    apiKey = config_1.bubbleConfig.apiKey, domain = config_1.bubbleConfig.domain, isDev = config_1.bubbleConfig.isDev;
                    sortOption = options.sortOption, constraints = options.constraints;
                    baseUrl = isDev
